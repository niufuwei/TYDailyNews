...
-(void)loadLayoutView
{
    ...
    titleLabel6.textColor = myBlackColor;
    ...
    titleLabel7.text = @"年";
    titleLabel7.textColor = myBlackColor;
    ...
    titleLabel8.text = @"月";
    titleLabel8.textColor = myBlackColor;
    ...
    titleLabel9.text = @"日";
    titleLabel9.textColor =myBlackColor;
    ...
    titleLabel5.textColor = myBlackColor;
